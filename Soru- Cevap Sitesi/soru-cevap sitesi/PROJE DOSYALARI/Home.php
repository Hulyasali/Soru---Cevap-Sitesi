            ...
            echo "<div class='box1'>";
                    echo "<a href='q-page.php?q_id=$q_id&user_id=$user_id'>";
                        echo '<div class="some">';
                            ...
                            if($num_rows3 > 0){
                                echo "<p class='begen'>";
                                echo "<a class='link' href='likes-delete.php?q_id=$q_id&user_id=$user_id&url=$urlal'>Beğen($like)</a>";
                                echo "</p>";
                            }else{                                
                                echo "<p class='begen'>";
                                echo"<a class='link' href='q-like.php?q_id=$q_id&user_id=$user_id&url=$urlal'>Beğen($like)</a>";
                                echo "</p>";
                            }
                            ...
                            if($num_rows5 > 0){
                                echo "<p class='begenme'>";
                                echo "<a class='link' href='likes-delete.php?q_id=$q_id&user_id=$user_id&url=$urlal'>Beğenme($dislike)</a>";
                                echo "</p>";
                            }else{                                
                                echo "<p class='begenme'>";
                                echo "<a class='link' href='q-dislike.php?q_id=$q_id&user_id=$user_id&url=$urlal'>Beğenme($dislike)</a>";
                                echo "</p>";
                            }
                            ...
                            if($num_rows8 > 0){
                                ...
                                echo "<p class='duzenle'>";
                                echo "<a class='link' href='q-update-form.php?q_id=$q_id&url=$urlal'>Düzenle</a>";
                                echo "</p>";
                            }else{}
                            ...
                            if($num_rows9 > 0){
                                ...
                                echo "<p class='sil'>";
                                echo "<a  class='link' href='q-delete-form.php?q_id=$q_id&url=$urlal'>Sil</a>";
                                echo "</p>";
                            }else{}
                            ...
                            if($num_rows7 > 0){
                                echo "<p class='yanıtla'>";
                                echo"<a class='link' href='q-page.php?q_id=$q_id&user_id=$user_id'>Yanıtla($yanıt_say)</a>";
                                echo "</p>";
                            }
